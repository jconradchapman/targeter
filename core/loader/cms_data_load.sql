...
Targeter - CMS DE-SynPUF DATA LOAD SCRIPT
Queries needed to create data tables and load data from .csv files
jchapman - created: 4.15.2022 modified:
*/


-- create table for and load beneficiaries
...
SELECT * FROM ts_cms_desynpuf_beneficiaries;


-- create table for and load inpatient_claims
...
SELECT * FROM ts_cms_desynpuf_inpat_claims;


-- create table for and load outpatient_claims
...
SELECT * FROM ts_cms_desynpuf_outpat_claims;


-- create table for and load carrier_claims
...
SELECT * FROM ts_cms_desynpuf_carrier_claims;
